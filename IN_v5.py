...
fOne = h5py.File("/data/t3home000/keiran/HtautauData_taus/hadhad/comb_distcut2_flat_hadhad_QCD,ohe_taus.z", 'r')
...
modelName="IN_hadhad_v5,on_QCD,take_1"
...
convOneTau = Conv1D(60,kernel_size=1,activation="relu",name="convOneTau")(inputTau)
convTwoTau = Conv1D(30,kernel_size=1,activation="relu",name="convTwoTau")(convOneTau)
convThreeTau = Conv1D(20,kernel_size=1,activation="relu",name="convThreeTau")(convTwoTau)
normOneTau = BatchNormalization(momentum=0.6,name="normOneTau")(convThreeTau)
rowTau = Flatten(name="rowTau")(normOneTau)

denseOneTau = Dense(60,activation="relu",name="denseOneTau")(rowTau)
normTwoTau = BatchNormalization(momentum=0.6,name="normTwoTau")(denseOneTau)
denseTwoTau = Dense(30,activation="relu",name="denseTwoTau")(normTwoTau)
denseThreeTau = Dense(20,activation="relu",name="denseThreeTau")(denseTwoTau)
normThreeTau = BatchNormalization(momentum=0.6,name="normThreeTau")(denseThreeTau)

# Calculate output
OBar = Lambda(lambda tensor: K.sum(tensor, axis=1), name="OBar")(O)
combined = Concatenate(axis=1,name="combined")([OBar,normThreeTau])

denseEndOne = Dense(50, activation="relu", name="denseEndOne")(combined)
normEndOne = BatchNormalization(momentum=0.6, name="normEndOne")(denseEndOne)
denseEndTwo = Dense(20, activation="relu", name="denseEndTwo")(denseEndOne)
...
model = Model(inputs=[inputParticle, inputSV, inputTau], outputs=[output])
...
history = model.fit([particleTrainingData, svTrainingData, tauTrainingData], trainingLabels, epochs=numberOfEpochs, batch_size=batchSize,
                    callbacks=modelCallbacks,
                    validation_data=([particleValidationData, svValidationData, tauValidationData], validationLabels))
...
predictions = model.predict([particleTestData, svTestData, tauTestData])
