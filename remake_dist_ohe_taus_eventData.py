...
with open("../pf_event.json") as jsonfile:
...
with open("../pf_event.json") as jsonfile:
    ...
    taufeatures_bkg = payload['taufeatures']
...
lColumns = lColumns + lPartfeatures + lSVfeatures + lTaufeatures + [label]
...
ntaus = 3
lTaufeatures_bkg = []
for iVar in taufeatures_bkg:
    for i0 in range(ntaus):
        lTaufeatures_bkg.append(iVar + str(i0))

lColumns_bkg = lColumns_bkg + lPartfeatures_bkg + lSVfeatures_bkg + lTaufeatures_bkg + [label_bkg]
...
for iVar in taufeatures:
    for i0 in range(ntaus):
        lTaufeatures_end.append(iVar + str(i0))

lColumns_end = lColumns_end + lPartfeatures_end + lSVfeatures_end + lTaufeatures_end + [label]
...
if __name__ == "__main__":
    ...
    remake(['/data/t3home000/keiran/HtautauData_event/hadel/FlatTauTau_user.z'], ['/data/t3home000/keiran/HtautauData_event/hadel/TTbar.z','/data/t3home000/keiran/HtautauData_event/hadel/WJetsToLNu.z'], '/data/t3home000/keiran/HtautauData_event/hadel/comb_distcut1_5_flat_hadel_TTbar_WJets,ohe,event.z')
